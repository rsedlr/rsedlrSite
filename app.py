...
logging.basicConfig(level=logging.DEBUG, format='%(asctime)s - %(message)s', datefmt='%d/%m/%Y %I:%M:%S %p')  # level=logging.DEBUG, '%(asctime)s - %(levelname)s - %(message)s' filename='site.log'
