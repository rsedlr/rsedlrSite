  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light" id="mainNav">
      <div class="container nav-cont">
        <a class="navbar-brand js-scroll-trigger" href="#page-top" style="font-size: 22px"
          >HOME</a
        >
        <button
    ...
    <section class="bg-primary text-center" id="about">
      <div class="container">
        ...
        <div class="fade">
          <h1 class="secHead">
            I'm a Computer Science student, studing at the University of Warwick. Awarded
            3 A*s in A-level Computer Science, Maths and Physics at Beths Grammar school.
          </h1>
        </div>
        <div class="fade">
          <h1 class="mainQuote">
        ...
        >
          <div class="tooltip" style="text-align: center !important">
            <h3 style="color: white; font-weight: bold" id="emailTxt">
              Or send me an email directly at:<br /><a
                id="emailCopy"
                href="javascript:void(null);"
                style="color: var(--other-orange)"
                >rsedlr@protonmail.com</a
              >
            </h3>
