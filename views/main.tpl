      ...
      <div class="row h-100">
        <div class="col-md-9 col-sm-12" style="margin: auto auto 0 0;">
          ...
          <div class="showSmall my-auto" style="text-align: center;">
            <h1 style="font-size: 6.1rem; font-weight: 800; padding-left: 5px; color: white !important">Reiss Edler</h1>
            <h2 style="font-size: 4rem; font-weight: 400; padding-left: 8px; color: white !important">personal portfolio</h2>
          </div>
        </div>
