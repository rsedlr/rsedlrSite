   ...
   <body id="page-top">
      ...
      <section class="bg-primary text-center" id="about">
         <div class="container">
            ...
            <div class="fade">
               <h1 class="secHead">
                  I'm a Computer Science student, studing at the University of Warwick.
            ...
            <div class="fade">
               <h1 class="mainQuote">
                  ...
                  ... was a punctual, responsible and personable young man. Capable of
                  thinking on his feet and handling a variety of situations."
                  <span class="spacer"></span>
      ...
      <section class="bg-third text-center" id="contact">
         <div class="container" style="max-width: 800px">
            ...
            <!-- <form role="form" id="contactForm">
               ...
               <div class="fade">
                  <button
                     type="submit"
                     id="form-submit"
                     class="btn proj-btn main-btn btn-lg"
                     style="margin: 10px"
                  >
                     Submit
                  </button>
            ...
            <div
               class="boxCol fit-content fade"
               style="margin-top: 40px; padding-bottom: 15px"
            >
               <div class="tooltip" style="text-align: center !important">
                  <h3 style="color: white; font-weight: bold" id="emailTxt">
                     Send me an email at:<br /><a
                        id="emailCopy"
                        href="javascript:void(null);"
                        style="color: var(--other-orange)"
                        >reissedler@gmail.com</a
                     >
                  </h3>
