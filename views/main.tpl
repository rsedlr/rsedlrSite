    ...
    <div class="container h-100">
      <div class="row h-100">
        <div class="col-lg-12 my-auto">
          <div class="header-content mr-auto hideSmall" id="mainText" style="margin-left: 100px"><!-- text added through js --></div>
          <div class="header-content mr-auto hideSmall" id="secText" style="margin-left: 100px"><!-- text added through js --></div>
