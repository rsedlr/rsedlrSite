...
<html lang="en">
   <head>
      ...
      <script
         ...
         crossorigin="anonymous"
      ></script>
      <script src="/static/main/main.min.js?v=1.00"></script>
      <script src="/static/main/background.min.js?v=1.00"></script>
   ...
   <body id="page-top">
               ...
               <div id="titleContainer">
                  ...
                  <div class="showSmall" id="smallTitleDiv">
                     <h1 style="font-size: 70px; font-weight: 800; line-height: 1">
                        <span style="letter-spacing: 3px">Reiss</span>
                        <span style="letter-spacing: 5px">Edler</span>
                     </h1>
                     <h2 style="font-size: 40px; font-weight: 400; line-height: 1.1">
                        <span style="margin-left: 2px; letter-spacing: 2.2px"
                           >Software</span
                        >
         ...
         <div class="container">
            ...
            <div class="fade">
               <h1 class="secHead">
                  ...
                  Awarded 3 A*s in A-level Computer Science, Maths and Physics at Beths
                  Grammar school.
               </h1>
            </div>
            <div class="fade">
               <h1 class="mainQuote">
                  ...
                  <span class="spacer"></span> ... was a punctual, responsible and
                  personable young man. Capable of thinking on his feet and handling a
                  variety of situations." <span class="spacer"></span> - Simon Brown
                  (NowTV work experience manager)
               </h1>
            </div>
         </div>
      </section>
      <section class="bg-footer text-center" id="experience">
         <div class="container">
            ...
            <div class="fade" style="padding-top: 25px">
               <button class="btn proj-btn main-btn" id="moreProjBtn" type="button">
                  Show More
               </button>
            </div>
         </div>
      ...
      <section class="bg-footer socials" id="contact">
         <div
            class="mx-auto fade"
            style="text-align: center; margin-left: -4rem; margin-right: -4rem"
         >
