...
<html lang="en">
  ...
  <body>
    ...
    <div id="Main" class="row">
      ...
      <div class="col-xxl-6 col-xl-12 mainWidthMax boxCol" style="margin: 15px auto;" id="relayBox">
        ...
        <div class="row boxRow">
          <button type="button" class="btn btn-lg mainbtn my-primary-w" style="margin: 0px; width: 200px;" id="T-lightsButton">lights</button>
          <!-- <h1 style="padding: 5px 20px; color: white;"></h1> -->
    ...
    <div class="col-xxl-6 col-xl-12 mainWidthMax boxCol" style="margin: 15px auto;" id="LED_box">
      <h1 style="color:red; margin-bottom: 25px;"><b>LED control</b></h1>
      <div class="row boxRow">
        <button type="button" class="btn btn-lg mainbtn my-primary-w" style="margin: 0px; width: 200px;" id="B-lightsButton">LED</button>
        <!-- <h1 style="padding: 5px 20px; color: white;"></h1> -->
        <div id="LED_circle" class="circle smallCircle" style="background: rgb(255, 0, 0); float: right; margin: -5px 2px auto auto;"></div>
        <div id="B-lights_circle" class="circle smallCircle" style="background: rgb(255, 0, 0); float: right; margin: -5px 2px auto 13px;">
          <span id="B-lights_status" class="disNone">{{lights_B}}</span>
        </div>
      </div>
      <div id="LED_buttonContainer">
